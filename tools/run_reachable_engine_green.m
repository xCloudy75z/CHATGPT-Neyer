...
output_path = fullfile(project_root, 'audit', 'overnight', ...
    'reachable-engine-green-test.txt');
file_id = fopen(output_path, 'w');
assert(file_id >= 0, 'Could not create reachable engine evidence.');
fprintf(file_id, 'Reachable physical-engine tests after implementation\n');
