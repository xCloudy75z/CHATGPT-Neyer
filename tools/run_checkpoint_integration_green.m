...
output_path = fullfile(project_root, 'audit', 'overnight', ...
    'checkpoint-integration-green-test.txt');
file_id = fopen(output_path, 'w');
assert(file_id >= 0, 'Could not create checkpoint integration evidence.');
fprintf(file_id, 'Run-loop checkpoint tests after integration\n');
