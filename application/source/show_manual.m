...
%SHOW_MANUAL Show the scrollable gap-study operator guide.
    ...
    uilabel(heading, 'Text', 'Neyer Gap Test V1.14 - operator guide', ...
...
function sections = help_sections()
    ...
    sections(2) = section('What each direct input means', sprintf([ ...
        ...
        'of the 50/50 change.\n\n' ...
        'First study - variation unknown - use this default when you do not ' ...
        'already know the overall variation. The program chooses an internal starting search ' ...
        'scale; it does not call that value a measured variation.\n\n' ...
        'Advanced - starting variation known - use this only when earlier ' ...
        'evidence gives a reasonable starting value.\n\n' ...
        ...
        'No planner result, accuracy target, reliability level, or confidence ' ...
        'entry is required to start this gap study.']));
    ...
    sections(4) = section('What to do for each new setup', sprintf([ ...
        ...
        'measured gap.\n\n' ...
        '2. Take one measured gap reading from the completed new setup. Enter ' ...
        'that one reading as ' ...
    ...
    sections(7) = section('Saving and reopening', sprintf([ ...
        ...
        'Keep the result window open while reviewing or saving the current run. ' ...
        'Saved CSV and HTML files are permanent records for review outside the ' ...
        'app; they are not resumable test sessions.']));
    ...
    sections(8) = section( ...
        ...
        'failure.'], ...
        ['The main study estimates the middle gap, overall variation, and ' ...
        'response curve. It does not promise a fixed number of articles when ' ...
        'the true variation is unknown.'], ...
        ['A fixed-gap reliability demonstration is a separate later study: ' ...
        'first choose one gap, ' ...
