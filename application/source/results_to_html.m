...
% shown only when the data support one; missing limits are described in words.
    ...
    txt = strjoin({ ...
        ...
        '<p>Each row contains one measured gap. Measurement uncertainty was not assessed from one reading.</p>', ...
        test_table, ...
        chart_section, ...
...
function table_html = completed_test_table(result, levels, successes, unit)
    ...
    table_html = strjoin({ ...
        ...
        '<th>Actual measured gap</th><th>Measurement uncertainty</th><th>Outcome</th></tr></thead><tbody>', ...
