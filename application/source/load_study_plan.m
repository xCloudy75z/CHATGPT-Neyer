...
%LOAD_STUDY_PLAN Reopen a supported human-readable JSON study plan.
    ...
    loaded_path = absolute_path(selected_path);
    ...
    if ~strcmp(version_text, '1.0')
        error('load_study_plan:unsupportedVersion', ...
            ['This study plan uses version %s. This tool supports version 1.0; ' ...
             'the file was not changed.'], version_text);
    end
