...
function sections = help_sections()
    ...
    sections(2) = section('What each direct input means', sprintf([ ...
        ...
        'Unit - direct testing currently uses millimetres. Keep this as mm.\n\n' ...
    ...
    sections(3) = section('Regular step versus confirmed list', sprintf([ ...
        ...
        'gaps. Enter each allowed value once, separated by commas and using no ' ...
        'more than two decimal places; for example, 1.00, 1.10, 2.50. The tool ' ...
        'requests only a value from that list.\n\n' ...
